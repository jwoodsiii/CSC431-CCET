...
(function($){
    $.fn.myEditer = function(opts, params){
        if($.isObject(opts) || opts == null){
            return this.each(function(){
                if(!$(this).data('myEditer'))
                    $(this).data('myEditer', new myEditer(this, opts));
            });
        } else if(this.length == 1){
            try {
                var t = $(this).data('myEditer');
                switch(opts){
                    // Modal box
                    case 'openModal':
    ...
    var myEditer = function(editorElem, opts){
        // jQuery object of the editor
        this.$e       = $(editorElem);
        this.$creator = $(editorElem);

        // Extend with options
        opts = $.extend(true, {}, opts, $.myEditer.opts);

        // Localization management
        if(typeof opts.lang === 'undefined' || typeof $.myEditer.langs[opts.lang] === 'undefined')
            this.lang = $.myEditer.langs['en'];
        else
            this.lang = $.extend(true, {}, $.myEditer.langs['en'], $.myEditer.langs[opts.lang]);
        ...
        this.o = $.extend(true, {
            ...
            btns: ['viewHTML',
                        '|', 'formatting',
                        '|', $.myEditer.btnsGrps.design,
                        '|', 'link',
                        '|', 'insertImage',
                        '|', $.myEditer.btnsGrps.justify,
                        '|', $.myEditer.btnsGrps.lists,
                        '|', 'horizontalRule'],
            btnsAdd: [],
    ...
    myEditer.prototype = {
        ...
        buildEditor: function(disable){
            ...
            this.$box = $('<div/>', {
                'class': this.o.prefix + 'box ' + this.o.prefix + this.o.lang + ' myEditer'
            });
        ...
        destroy: function(){
            ...
            this.$box.remove();
            this.$creator.removeData('myEditer');
        },
        ...
        /*
         * Call method of myEditer if exist
        ...
        // Return true if must enable myEditer on this mobile device
        isEnabled: function(){
